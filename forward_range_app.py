...
def run_ui():
    ...
    if src == "Fetch by ticker":
        ...
        years = sb.number_input("Years of history", 1, 20, 5)
    else:
    ...
    with sb.expander("⚙  Model settings", expanded=not simple):
        vol_kind = st.selectbox("Volatility model",
                                ...
                                help="EWMA+VoV adds a vol-of-vol inflation that measured slightly "
                                     ...
                                     "Blend accuracy-weights several models; Constant = flat sd")
    ...
    with sb.expander("📈  Options market (implied view)", expanded=False):
        ...
        if use_iv:
            ...
            st.caption("Builds the market's full implied distribution from the smile "
