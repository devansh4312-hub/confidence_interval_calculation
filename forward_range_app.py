...
# ======================================================================
def run_ui():
    st.set_page_config(page_title="Forward Price Range", layout="wide")
    ...
    ticker, years, uploaded = None, 3, None
    if src == "Fetch by ticker":
        ticker = sb.text_input("Ticker", value="^NSEI",
                               help="NSE stocks use a .NS suffix (e.g. RELIANCE.NS); "
                                    "NIFTY 50 index = ^NSEI").strip()
    ...
    horizon_days = sb.number_input("Horizon (calendar days)", 1, 365, 30)
